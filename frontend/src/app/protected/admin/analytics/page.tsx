...
function EmptyVisual({
  ...
  return (
    <div className={styles.emptyVisual}>
      ...
      <p>
        Add feedback to start building
        this view.
      </p>
    </div>
  );
  ...
  return (
    <div className={styles.tooltip}>
      ...
      {payload.map(
        (entry, index) => (
          <p
            key={`${entry.name ?? entry.dataKey}-${index}`}
          >
            <i
              style={{
                background:
...
export default function AnalyticsPage() {
  ...
  function updateDraftFilter<
    Key extends keyof DashboardFilters,
  >(
    key: Key,
          ...
          >
            ...
            >
              ...
              <Area
                ...
                stroke="#5b2cf0"
                strokeWidth={2.4}
                fill="url(#analyticsFeedbackFill)"
                dot={{
                  r: 3,
                  fill: "#5b2cf0",
                }}
  ...
  const topThemesCard = (
    ...
    >
      {isEmpty ? (
        <EmptyVisual
          label="No themes discovered yet"
        />
      ) : (
        <>
          <div
  ...
  const tabContent:
    ...
    Overview: (
      <>
        ...
        >
          {feedbackByChannelCard}
          {engagementImpactCard}
          {aiOverviewCard}
        </section>
      </>
    ),
          ...
          <main>
            ...
            >
              ...
              <MetricCard
                ...
                label="AI classified"
                value={aiClassified.toLocaleString()}
                change={trendChange(
                  totals,
                )}
                tone="purple"
