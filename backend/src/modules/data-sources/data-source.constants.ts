...
export const DATA_SOURCE_MESSAGES = {
  ...
  listed: "Data sources retrieved successfully",
  retrieved: "Data source retrieved successfully",
  syncStarted: "Data source sync completed",
  notFound: "Data source was not found",
  authenticationRequired: "Authentication is required",
  workspaceRequired: "Workspace is required",
  manageForbidden: "You do not have permission to manage data sources",
  deleteForbidden: "Only administrators can delete data sources",
} as const;
