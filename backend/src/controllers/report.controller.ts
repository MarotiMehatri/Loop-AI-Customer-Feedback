...
export const reportController = {
  ...
  getShipmentReport: asyncHandler(async (req: Request, res: Response) => {
    ...
    const result = await reportService.getShipmentReport(
      workspaceId,
      startDate,
      endDate,
      status,
  ...
  getCourierReport: asyncHandler(async (req: Request, res: Response) => {
    ...
    const result = await reportService.getCourierReport(
      workspaceId,
      startDate,
      endDate,
      courierId,
  ...
  exportPdf: asyncHandler(async (req: Request, res: Response) => {
    ...
    res
      .status(200)
      .json({ success: true, message: "Report data exported", data: report });
  }),
